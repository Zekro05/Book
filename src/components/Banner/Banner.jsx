            ...
            <div className="container">
                <div className="grid grid-cols-1 sm:grid-cols-2 items-center gap-6">
                    ...
                    className="flex flex-col justify-center gap-6 sm:pt:-0">
                        <h1 className="text-3xl sm:text-4xl font-bold">Library at your fingertips
                        </h1>
                        <p className="text-sm text-gray-500 tracking-wide leading-5">
                        "Explore a world of knowledge and imagination anytime, anywhere. From classic literature to modern masterpieces, your next great read is just a click away!"
